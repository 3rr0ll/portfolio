...
<section id="projects" class="py-20 bg-gray-50 dark:bg-gray-800 transition-colors duration-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col space-y-10 mt-4">
            <?php foreach ($projects as $index => $project): ?>
                <div class="flex flex-col md:flex-row bg-white dark:bg-gray-900 rounded-lg shadow-md hover:shadow-xl transition-shadow overflow-hidden border border-gray-200 dark:border-gray-700 mb-4">
                    <!-- Project info: title/desc/tech -->
