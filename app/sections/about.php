        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="prose prose-lg dark:prose-invert max-w-none">
                <p class="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
                    Hello! I'm a junior web developer with a passion for creating functional and elegant web solutions. 
                    My journey in web development began with learning the fundamentals of PHP and gradually expanding 
                    to modern frameworks and tools.
                </p>
                <p class="text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
